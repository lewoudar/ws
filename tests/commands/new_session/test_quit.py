...
from ws.commands.new_session import interact


async def test_should_print_documentation_and_exit_program(capsys, nursery, mock_input):
    mock_input.send_text('quit\n')
